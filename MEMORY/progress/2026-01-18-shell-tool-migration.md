...
2. **Provider tool compatibility**: Removed `google_search` and `url_context` tools because Gemini doesn't support combining provider-defined tools with custom function tools
